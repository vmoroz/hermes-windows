...
TEST_P(NapiTest, test_basics_RunScript) {
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    size_t strSize;
    ASSERT_EQ(
        napi_ok, napi_get_value_string_utf8(env, value, nullptr, 0, &strSize));
    ASSERT_EQ(strSize, 5);

    char strBuf[6];
    ASSERT_EQ(
        napi_ok, napi_get_value_string_utf8(env, value, strBuf, 6, nullptr));
    ASSERT_STREQ(strBuf, "Hello");
  });
}
...
TEST_P(NapiTest, test_basics_HostFunctionTest) {
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    ASSERT_EQ(
        napi_ok,
        napi_create_string_utf8(env, "Foo()", NAPI_AUTO_LENGTH, &script));
...
TEST_P(NapiTest, test_basics_PropertyStringGetSetTest) {
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    ASSERT_EQ(
        napi_ok,
        napi_create_string_latin1(env, "test", NAPI_AUTO_LENGTH, &propName));
...
TEST_P(NapiTest, test_basics_CreateStringType) {
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    ASSERT_EQ(
        napi_ok,
        napi_create_string_latin1(env, "test", NAPI_AUTO_LENGTH, &str));
...
TEST_P(NapiTest, test_basics_CreateSymbol) {
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    ASSERT_EQ(
        napi_ok,
        napi_create_string_latin1(env, "test", NAPI_AUTO_LENGTH, &symDesc));
...
TEST_P(NapiTest, test_basics_ExternalValueTest) {
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    ASSERT_EQ(
        napi_ok,
        napi_create_external(env, data.get(), nullptr, nullptr, &external));
  ...
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    ASSERT_EQ(
        ...
        napi_create_external(
            env, native_ptr.get(), nullptr, nullptr, &external));
...
TEST_P(NapiTest, test_basics_DateValueNaNTest) {
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    ASSERT_EQ(
        napi_ok,
        napi_create_date(env, std::numeric_limits<double>::quiet_NaN(), &date));
...
TEST_P(NapiTest, test_basics_PromisePropertyTest) {
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    ASSERT_EQ(
        napi_ok, napi_get_named_property(env, global, "Promise", &promiseCtor));
...
TEST_P(NapiTest, test_basics_NewInstanceTest) {
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    ASSERT_EQ(
        napi_ok, napi_get_named_property(env, global, "MyClass", &myClassCtor));
    ...
    ASSERT_EQ(
        napi_ok,
        napi_new_instance(env, myClassCtor, 0, nullptr, &myClassInstance));
    ...
    bool isInstOf;
    ASSERT_EQ(
        napi_ok, napi_instanceof(env, myClassInstance, myClassCtor, &isInstOf));
    ASSERT_TRUE(isInstOf);

    napi_value xValue;
    ASSERT_EQ(
        napi_ok, napi_get_named_property(env, myClassInstance, "x", &xValue));
...
TEST_P(NapiTest, test_basics_BigIntWords) {
  ExecuteNapi([](NapiTestContext * /*testContext*/, napi_env env) {
    ...
    ASSERT_EQ(
        napi_ok,
        napi_get_value_bigint_words(env, v01, &sign_bit, &word_count, words));
    ...
    ASSERT_EQ(
        napi_ok,
        napi_get_value_bigint_words(env, v02, &sign_bit, &word_count, words));
    EXPECT_EQ(0, sign_bit);
    EXPECT_EQ(0, word_count);
    ...
    ASSERT_EQ(
        napi_ok,
        napi_get_value_bigint_words(env, v03, &sign_bit, &word_count, words));
    EXPECT_EQ(0, sign_bit);
    ...
    ASSERT_EQ(
        napi_ok,
        napi_get_value_bigint_words(env, v04, &sign_bit, &word_count, words));
    ...
    ASSERT_EQ(
        napi_ok,
        napi_get_value_bigint_words(env, v05, &sign_bit, &word_count, words));
    EXPECT_EQ(0, sign_bit);
    EXPECT_EQ(1, word_count);
    ...
    ASSERT_EQ(
        napi_ok,
        napi_get_value_bigint_words(env, v06, &sign_bit, &word_count, words));
    ...
    ASSERT_EQ(
        napi_ok,
        napi_get_value_bigint_words(env, v07, &sign_bit, &word_count, words));
    ...
    ASSERT_EQ(
        napi_ok,
        napi_get_value_bigint_words(env, v08, &sign_bit, &word_count, words));
    ASSERT_EQ(1, sign_bit);
    EXPECT_EQ(4, word_count);
